...
setwd("/home/barefootbushman/Desktop/DWER Thresholds analysis/DWER_Thresholds/Jandabup")

Y <- comm$Jandabup
wat.obs <- data.ls$'6162578'
ahd <- AHD.data.list$Jandabup.AHD
ahd.p <- Params.data.list$Jandabup.params
WL_group <- "surface"
gw.plot <- Site.GW.plots$jand.p
a.ele <- 44.97
b.ele <- 39.554
c.ele <- 48.565
d.ele <- 48.255
