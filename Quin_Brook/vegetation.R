...
setwd("/home/barefootbushman/Desktop/DWER Thresholds analysis/DWER_Thresholds/Quin_Brook")

Y <- comm$Quin_Brook
wat.obs <- data.ls$'61710060'
ahd <- AHD.data.list$QuinBrook.AHD
ahd.p <- Params.data.list$QuinBrook.params
WL_group <- "ground"
gw.plot <- Site.GW.plots$quin.p
a.ele <- 57.62
b.ele <- 57.898
c.ele <- 58.198
d.ele <- 58.596
