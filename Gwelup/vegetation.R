...
setwd("/home/barefootbushman/Desktop/DWER Thresholds analysis/DWER_Thresholds/Gwelup")

Y <- comm$Gwelup
wat.obs <- data.ls$'6162504'
ahd <- AHD.data.list$Gwelup.AHD
ahd.p <- Params.data.list$Gwelup.params
WL_group <- "surface"
gw.plot <- Site.GW.plots$gwel.p
a.ele <- 5.85
b.ele <- 6.263
c.ele <- 6.357
