...
load("/home/barefootbushman/Desktop/DWER Analysis/Data_prep/Data_prep/Refined_data.RData")

Y <- comm$Goolelal
wat.obs <- data.ls$'6162517'
ahd <- AHD.data.list$Goollelal.AHD
ahd.p <- Params.data.list$Goollelal.params
WL_group <- "surface"
gw.plot <- Site.GW.plots$gool.p
a.ele <- 26.66
b.ele <- 26.79
c.ele <- 26.855
d.ele <- 26.973
