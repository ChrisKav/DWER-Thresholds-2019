...
ahd <- AHD.data.list$McNess.AHD
ahd.p <- Params.data.list$McNess.params
WL_group <- "surface"
gw.plot <- Site.GW.plots$mcness.p
a.ele <- 7.028
b.ele <- 7.383
c.ele <- 7.709
d.ele <- 7.828
...
GW.levs.d$Plot <- "D"
GW.levs.z <- GW.levs
GW.levs.z$meanGW <- GW.levs.z$meanGW - z.ele
GW.levs.z$Plot <- "Z"
GW.levs <- rbind(GW.levs.a,GW.levs.b,GW.levs.c,GW.levs.d,GW.levs.z)
