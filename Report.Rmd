...
[INSERT PART ABOUT REVISED MANAGEMENT OBJECTIVES]
...
Twenty wetlands from the Bassendean and Spearwood Dune systems are analysed in this report to assess the ecoogical and managerial impacts of revised groundwater thresholds (Table \ref{tab:WetMeta}). [HOW DO THE WANNEROO WETLANDS FIT INTO THIS SYSTEM. NEED TO CONFIRM DUNAL SYSTEMS IN TABLE. GINGIN = Pinjarra Plain?]

```{r WetMeta, echo=FALSE, results='asis'}
  cat(' Table: \\label{tab:WetMeta}Summary of wetlands.
  
|  Wetland | Dunal System | Veg/Invert Monitoring | Coordinates |
| :------------: |:------------: |:-----------:|:-----------:|
|Lake Goollelal|Urban Spearwood Dunes|Veg & Invert|31.817&deg;S 115.815&deg;E|
|Loch McNess|Peri-Urban Spearwood Dunes|Veg & Invert|31.548&deg;S 115.682&deg;E|
|Lake Yonderup|Peri-Urban Spearwood Dunes|Veg & Invert|31.555&deg;S 115.686&deg;E|
|Lake Joondalup|Urban Spearwood Dunes|Veg & Invert|31.743&deg;S 115.779&deg;E|
|Lake Mariginiup|East Wanneroo Interdunal|Veg & Invert|31.729&deg;S 115.815&deg;E|
|Lake Jandabup|East Wanneroo Interdunal|Veg & Invert|31.746&deg;S 115.847&deg;E|
|Lake Nowergup|Peri-Urban Spearwood Dunes|Veg & Invert|31.630&deg;S 115.732&deg;E|
|Lake Wilgarup|Spearwood Dunes|Veg|31.575&deg;S 115.690&deg;E|
|Pipidinny Swamp|Spearwood Dunes|Veg|31.580&deg;S 115.683&deg;E|
|Lexia 186|Bassendean Dunes|Veg|31.743&deg;S 115.963&deg;E|
|Melaleuca Park 173|Bassendean Dunes|Veg & Invert|31.704&deg;S 115.963&deg;E|
|Melaleuca Park 78|Bassendean Dunes|Veg|31.704&deg;S 115.915&deg;E|
|MM59B - Whiteman Park East|Bassendean Dunes|Veg|31.804&deg;S 115.954&deg;E|
|PM9 - Pinjar North|Bassendean Dunes|Veg|31.612&deg;S 115.843&deg;E|
|WM1 - Pinjar|Bassendean Dunes|Veg|31.655&deg;S 115.855&deg;E|
|WM2 - Melaleuca Park North|Bassendean Dunes|Veg|31.662&deg;S 115.895&deg;E|
|WM8 - Melaleuca Park|Bassendean Dunes|Veg|31.694&deg;S 115.930&deg;E|
|Lake Gwelup|East Wanneroo Interdunal |Veg|31.878  &deg;S 115.791  &deg;E|
|Quin Brook|Bassendean Dunes|Veg|31.450&deg;S 115.812&deg;E|
|Gingin Brook|Bassendean Dunes|Veg|31.348&deg;S 115.717&deg;E|
')
...
Summary table (Table \ref{tabSumTable}).
...
| :------------ | :-----------: | :------: | :------------ |
|Lake Goollelal|26.0|26.4|The lake will remain permanately innundated at similar levels as present. Fringing vegetatiion will persist and provide habitat for the current diversity of aquatic invertebrates. The site will continue acting as a drought refuge for water birds and provide important habitat to important native fish species.|
|Loch McNess|6.95|6.20||
...
Add some description of the results presented in Figure \ref{fig:Allvegheight} and Figure \ref{fig:AllVegOrd}.

```{r Allvegheight, fig.cap="\\label{fig:Allvegheight}Range of depth to water level experienced by some plant species at a few sites with reliable water monitoring during the survey period.", results = 'asis'}
load("All_vegetation/Complete_veg_analysis.RData")
wetland.height.plot
```

```{r AllVegOrd, fig.cap="\\label{fig:AllVegOrd}Unconstrained ordination plot of all vegetation surveys at each wetland site during the survey period (1996-2018). Arrows represnt change from first survey to last survey.", results = 'asis'}
load("All_vegetation/Complete_veg_analysis.RData")
...
| * Maintain the existing hydrological regime | The loss of stable water levels (once a characteristic of the lake) have deteriorated to the point where water levels have declined by 1.5 m and are susceptible to further declines under a drying climate.| No |
')
