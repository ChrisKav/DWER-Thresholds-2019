...
Most wetlands have lost families since the period 1996-2000, with the exception of Lake Goollelal and Loch McNess (Figure \ref{fig:InvertRich}). There are 20 families of aquatic macroinvertebrates that are now locally extinct from the monitored wetlands and seven families that were not recorded in the initial 1996-2000 (Table \ref{tab:ExtinctTab}).
...
```{r ExtinctTab, echo=FALSE, results='asis'}
  cat(' Table: \\label{tab:ExtinctTab}Families of aquatic macroinvertebrates that have been lost in the last 5 years (2018-2014) compared to the first five year period (1996-2000).
  
|  Gained | |Lost |
| :------------: |:-----------:| :-----------: | 
||**Mollusca**||
|Ancylidae||Sphaeriidae|
||**Acarina**||
|||Hydrachnidae|
|||Limnocharidae|
|||Limnesiidae|
