...
setwd("/home/barefootbushman/Desktop/DWER Thresholds analysis/DWER_Thresholds/Lexia_186")

Y <- comm$Lexia186
wat.obs <- data.ls$'61613214'
ahd <- AHD.data.list$Lexia186
ahd.p <- Params.data.list$Lexia186.params
WL_group <- "ground"
gw.plot <- Site.GW.plots$lex186.p
a.ele <- 49.97
b.ele <- 50.128
c.ele <- 50.326
d.ele <- 50.516
